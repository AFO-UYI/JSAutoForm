'use strict';class AutoForm{constructor(form_name,content_builder_function){this.input_type_list={'text':Text,'number':Number,'checkbox':Checkbox,'range':SimpleRange,'select':Select,'radio':RadioGroup,'checkboxgroup':CheckboxGroup}
